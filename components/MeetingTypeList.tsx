...
const MeetingTypeList = () => {
  ...
  return (
    <section className='grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4'>
      ...
      handleClick={() => setMeetingState('isScheduledMeeting')} className='bg-blue-1'/>
      ...
      handleClick={() => setMeetingState('isJoiningMeeting')} className='bg-yellow-1'/>
        ...
        {!callDetails ? (
          <MeetingModal isOpen={meetingState === 'isScheduledMeeting'}
          onClose={() => setMeetingState(undefined)}
          title="Create Meeting"
          handleClick={createMeeting}>
            <div className='flex flex-col gap 2.5'>
              <label className='text-base text-normal leading-[22px] text-sky-2'>Add a description
              </label>
